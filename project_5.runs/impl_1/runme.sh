...
HD_PWD='C:/Users/Ragha/Vivado_Projects/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ExtendedHammingDecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ExtendedHammingDecoder.tcl -notrace

...
HD_PWD='C:/Users/Ragha/Vivado_Projects/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ExtendedHammingDecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ExtendedHammingDecoder.tcl
